...
class TimelinePanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(TimelinePanel.viewType, 'MyPanel', column || vscode.ViewColumn.One, (0, exports.getWebviewOptions)(extensionUri));
...
TimelinePanel.viewType = 'catCvscode-branching-tutorials-navigationoding';
